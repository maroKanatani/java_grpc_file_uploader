...
@javax.annotation.Generated(
    ...
    comments = "Source: uploader.proto")
public final class FileServiceGrpc {

  private FileServiceGrpc() {}

  public static final String SERVICE_NAME = "uploader.FileService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<uploader.Uploader.FileRequest,
      uploader.Uploader.FileResponse> getUploadMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Upload",
      requestType = uploader.Uploader.FileRequest.class,
      responseType = uploader.Uploader.FileResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<uploader.Uploader.FileRequest,
      uploader.Uploader.FileResponse> getUploadMethod() {
    io.grpc.MethodDescriptor<uploader.Uploader.FileRequest, uploader.Uploader.FileResponse> getUploadMethod;
      ...
      synchronized (FileServiceGrpc.class) {
        if ((getUploadMethod = FileServiceGrpc.getUploadMethod) == null) {
          FileServiceGrpc.getUploadMethod = getUploadMethod = 
              io.grpc.MethodDescriptor.<uploader.Uploader.FileRequest, uploader.Uploader.FileResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "uploader.FileService", "Upload"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  uploader.Uploader.FileRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  uploader.Uploader.FileResponse.getDefaultInstance()))
  ...
  public static abstract class FileServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<uploader.Uploader.FileRequest> upload(
        io.grpc.stub.StreamObserver<uploader.Uploader.FileResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                uploader.Uploader.FileRequest,
                uploader.Uploader.FileResponse>(
  ...
  private static abstract class FileServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return uploader.Uploader.getDescriptor();
    }
